# Generated by Django 5.2.5 on 2025-09-30 14:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Payment Attemt',
                'verbose_name_plural': 'Payment Attempts',
                'db_table': 'payment_attemts',
                'ordering': ['-created_at'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('succeeded', 'Succeeded'), ('cancelled', 'Cancelled'), ('failed', 'Failed')], default='pending', max_length=20)),
